...
const AIRFIELDS = {
  ...
  EGTF:{ name:"Fairoaks Airport", city:"Chobham, Surrey", elevation:80, class:"Class G", type:"ATZ — AFIS (Aerodrome Flight Information Service)", runways:["06/24 — 813m"], region:"uk", weather_icao:"EGTF",
    hazards:[
    ...
    cfiNotes:"Good short-field practice location close to complex Southeast airspace, with genuine AFIS — not a self-announce field. Always confirm: have you checked NOTAMs before departure?",
  },
  EGLF:{ name:"Farnborough Airport", city:"Farnborough, Hampshire", elevation:238, class:"Class G", type:"ATZ — Full ATC Service (Tower, Approach, Radar)", runways:["06/24 — 2,440m"], region:"uk", weather_icao:"EGLF",
    hazards:[
      {id:"FULLATC",phase:["all"],sev:"medium",icon:"📻",title:"Full ATC Despite Class G",why:"Farnborough is one of Europe's busiest business-aviation airports, with a full ATC service including radar and approach control, despite sitting in Class G airspace.",detail:"Contact Farnborough on the appropriate frequency well before the ATZ boundary. Farnborough LARS also provides a radar advisory service to VFR traffic transiting the area — a useful resource given the surrounding airspace complexity."},
    ...
    cfiNotes:"Not a routine training field — reserve for advanced radio-procedure exposure given the traffic mix and airspace complexity. Farnborough is genuinely Class G despite the scale of operations here, which is itself a useful teaching point. Always confirm: have you checked NOTAMs before departure?",
  },
